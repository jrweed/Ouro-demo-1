...
function matchResultToCarrier(m: MatchResult): MatchedCarrier {
  ...
  return {
    ...
    equipment: eqLabels[m.truck.equipment_type] || m.truck.equipment_type,
...
export default function FindTrucksPage() {
  ...
  const equipLabel =
    load.equipmentType === "reefer_single" ? "Reefer Single-Temp"
    : load.equipmentType === "reefer_multi" ? "Reefer Multi-Temp"
    : load.equipmentType;
