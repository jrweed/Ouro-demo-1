...
import { Truck, Eye, EyeOff, ArrowRight, Sparkles } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-[#f9fafb] font-sans">
      ...
      <div className="hidden w-[480px] shrink-0 flex-col justify-between bg-gradient-to-br from-[#1d4ed8] to-[#2563eb] p-12 lg:flex">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xl font-bold text-white tracking-tight">ColdHaul</span>
        </div>
        ...
        <div>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/15 px-3.5 py-1.5">
            ...
            <span className="text-sm font-medium text-white/90">
              Southeast Reefer Logistics Network
            </span>
          </div>
          <h1 className="mb-4 text-4xl font-bold leading-tight text-white">
            Smarter cold-chain freight starts here.
          </h1>
          <p className="text-base leading-relaxed text-white/75">
            ColdHaul connects vetted reefer carriers with trusted 3PLs across
            SC, GA, NC, and FL — with network-wide pricing data built from
            real transactions across the Southeast.
          </p>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8 flex items-center gap-2.5 lg:hidden">
            ...
            <span className="text-xl font-bold text-[#111827]">ColdHaul</span>
          </div>

          <div className="mb-8">
            <h2 className="text-2xl font-bold text-[#111827]">Welcome back</h2>
            <p className="mt-1 text-sm text-[#6b7280]">
              Sign in to your ColdHaul account
            </p>
          </div>
