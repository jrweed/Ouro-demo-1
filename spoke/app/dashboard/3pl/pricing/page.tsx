    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="mt-1.5 text-sm text-[#6b7280]">
          Intelligent rate estimation and lane analysis for freight
        </p>
      </div>
      ...
      <div className="mb-8 overflow-hidden rounded-2xl border border-[#3b82f6]/20 bg-gradient-to-br from-[#eff6ff] to-[#dbeafe] px-8 py-10 text-center">
        ...
        <p className="mx-auto mt-2 max-w-md text-[14px] text-[#3b82f6]">
          We&apos;re building a powerful pricing engine tailored to freight in the Southeast. Check back soon.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <FeatureCard
          ...
          description="Visualize how produce season, holidays, and weather events historically affect freight rates in your region."
          color="#0ea5e9"
          bg="#f0f9ff"
        />
      </div>
